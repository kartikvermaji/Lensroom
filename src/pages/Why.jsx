  ...
  return (
    <div className='h-[110vh] md:h-auto lg:h-[100vh]'>
      <div className='flex flex-col md:flex-row space-y-5 md:space-y-0 justify-between items-center px-5 md:mt-20'>
        ...
        viewport={{ once:true, amount: 0.5 }}
         className='bg-black relative lg:w-[45vw] md:w-[50vw] md:h-[50vh] w-[90vw] h-[55vh]  lg:h-[55vh] text-slate-50 lg:mt-12  lg:p-5 md:px-5 lg:px-14 mt-10 md:mt-10'>
            <h1 className='font-[Poppins] lg:text-6xl text-3xl font-semibold w-[30vw] pt-6 pl-6 lg:pt-0 md:pl-0 md:mt-4'>WHY LENSROOM</h1>
