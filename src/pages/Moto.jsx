  ...
  return (
    <div className='flex justify-center items-center  bg-slate-50 h-[70vh] pb-[10vh]  md:h-[60vh] lg:h-[50vh] text-black'>
      ...
      className="flex justify-center lg:ml-24 items-center flex-col md:flex-row mt-[-4vh] md:space-x-20 lg:space-x-10  lg:mt-10 md:mt-0 w-[80vw]  ">
        <h1 className="lg:text-7xl md:text-5xl text-3xl mt-16 md:mt-20 lg:mt-0 lg:w-[50vw] text-center  md:text-left font-lightbold "> We capture the magic of your memories</h1>
