...
const Moto = () => {
  ...
  return (
    <div className='flex justify-center items-center  bg-slate-950 h-[70vh] pb-[10vh]  md:h-[50vh] text-slate-50'>
       <motion.div 
      ...
      className="flex justify-center lg:ml-24 items-center flex-col md:flex-row mt-[-4vh] md:space-x-20 lg:space-x-10  lg:mt-10 md:mt-0 w-[80vw]  ">
        <h1 className="lg:text-7xl md:text-5xl text-3xl mt-16 md:mt-8 lg:mt-0 lg:w-[50vw] text-center md:text-left font-lightbold "> We capture the magic of your memories</h1>
        <div className="md:w-[50vw] justify-center items-center">
        <p className="font-semibold md:text-sm text-sm text-center ml-[-4vw] w-[90vw] md:text-left  md:w-[44vw] lg:w-[35vw] mt-0 md:mt-10" >Discover the magic at photobooth, where every moment is a memory worth capturing. Our skilled photographers are dedicated to preserving your special occasions with creativity and passion. Let us transform your fleeting moments into everlasting memories</p>
